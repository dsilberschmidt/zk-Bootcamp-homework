...
declare class Circuit {
     ...
     */
    static witness: <T, S extends import("./circuit-value.js").FlexibleProvable<T> = import("./circuit-value.js").FlexibleProvable<T>>(type: S, compute: () => T) => T;
    /**
     ...
     */
    static array: <A extends import("./circuit-value.js").FlexibleProvable<any>>(elementType: A, length: number) => import("../bindings/lib/provable-snarky.js").InferredProvable<A[]>;
    /**
     * @deprecated use {@link Provable.assertEqual}
     */
    static assertEqual: {
        <T>(type: import("./circuit-value.js").FlexibleProvable<T>, x: T, y: T): void;
        <T_1 extends {
     ...
     */
    static equal: {
        <T>(type: import("./circuit-value.js").FlexibleProvable<T>, x: T, y: T): import("./bool.js").Bool;
        <T_1 extends {
            toFields(): import("./field.js").Field[];
     ...
     */
    static if: {
        <T>(condition: import("./bool.js").Bool, type: import("./circuit-value.js").FlexibleProvable<T>, x: T, y: T): T;
        <T_1 extends {
            toFields(): import("./field.js").Field[];
     ...
     */
    static switch: <T, A extends import("./circuit-value.js").FlexibleProvable<T>>(mask: import("./bool.js").Bool[], type: A, values: T[]) => T;
    /**
