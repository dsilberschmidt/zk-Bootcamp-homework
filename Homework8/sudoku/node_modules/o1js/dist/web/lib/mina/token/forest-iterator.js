...
import { MerkleListIterator, MerkleList, } from '../../provable-types/merkle-list.js';
export { TokenAccountUpdateIterator };
const AccountUpdateIterator = MerkleListIterator.createFromList(AccountUpdateForest);
...
class TokenAccountUpdateIterator {
    ...
    static create(forest, selfToken) {
        return new TokenAccountUpdateIterator(AccountUpdateIterator.startIterating(forest), MayUseToken.ParentsOwnToken, selfToken);
    }
    /**
    ...
    assertFinished(message) {
        assert(this.currentLayer.forest.isAtEnd(), message ?? 'TokenAccountUpdateIterator not finished');
    }
}
//# sourceMappingURL=forest-iterator.js.map