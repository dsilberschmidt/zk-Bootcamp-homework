...
import { AccountUpdate, Authorization, Body, Events, Permissions, Actions, TokenId, ZkappCommand, zkAppProver, ZkappPublicInput, AccountUpdateForest, AccountUpdateLayout, } from './account-update.js';
import { cloneCircuitValue, provable, toConstant, } from './circuit-value.js';
...
import { analyzeMethod, compileProgram, Empty, emptyValue, getPreviousProofsForProver, isAsFields, methodArgumentsToConstant, methodArgumentTypesAndValues, Proof, sortMethodArguments, } from './proof-system.js';
import { PublicKey } from './signature.js';
import { assertStatePrecondition, cleanStatePrecondition } from './state.js';
import { inAnalyze, inCheckedComputation, inCompile, inProver, snarkContext, } from './provable-context.js';
...
// external API
export { SmartContract, method, declareMethods, Account, Reducer };
...
function wrapMethod(method, ZkappClass, methodIntf) {
    ...
    return function wrappedMethod(...actualArgs) {
        ...
        try {
            ...
            let { accountUpdate, result: { result, children }, } = AccountUpdate.witness(provable({
