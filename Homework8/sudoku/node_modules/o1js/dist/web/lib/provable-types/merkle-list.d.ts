...
import { ProvableHashable } from '../hash.js';
...
declare class MerkleList<T> implements MerkleListBase<T> {
     ...
     * ```
     */
    static create<T>(type: ProvableHashable<T>, nextHash?: (hash: Field, value: T) => Field, emptyHash_?: import("../field.js").Field): typeof MerkleList<T> & {
        empty: () => MerkleList<T>;
...
declare class MerkleListIterator<T> implements MerkleListIteratorBase<T> {
     ...
     */
    static create<T>(type: ProvableHashable<T>, nextHash?: (hash: Field, value: T) => Field, emptyHash_?: import("../field.js").Field): typeof MerkleListIterator<T> & {
    ...
    static createFromList<T>(merkleList: typeof MerkleList<T>): {
         ...
         * Create a Merkle array type
         */
        create<T_1>(type: ProvableHashable<T_1>, nextHash?: (hash: import("../field.js").Field, value: T_1) => import("../field.js").Field, emptyHash_?: import("../field.js").Field): {
            new (value: MerkleListIteratorBase<T_1>): MerkleListIterator<T_1>;
            create<T_1>(type: ProvableHashable<T_1>, nextHash?: (hash: import("../field.js").Field, value: T_1) => import("../field.js").Field, emptyHash_?: import("../field.js").Field): any & {
            ...
            createFromList<T_2>(merkleList: typeof MerkleList<T>): any & {
                from: (array: T[]) => MerkleListIterator<T>;
                startIterating: (list: MerkleListBase<T>) => MerkleListIterator<T>;
                empty: () => MerkleListIterator<T>;
                provable: ProvableHashable<MerkleListIterator<T>>;
