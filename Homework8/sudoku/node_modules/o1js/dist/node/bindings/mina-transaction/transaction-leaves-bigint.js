...
import { Poseidon, HashHelpers, packToFields, } from '../../provable/poseidon-bigint.js';
...
const { TokenId, StateHash, TokenSymbol, AuthRequired, ZkappUri } = derivedLeafTypesSignable({ Field, Bool, HashHelpers, packToFields });
