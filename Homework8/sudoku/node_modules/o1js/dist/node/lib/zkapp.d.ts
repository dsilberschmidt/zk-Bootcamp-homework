...
import { AccountUpdate, Permissions, SetOrKeep, ZkappPublicInput, AccountUpdateForest, AccountUpdateTree } from './account-update.js';
import { FlexibleProvablePure, InferProvable } from './circuit-value.js';
import { Provable } from './provable.js';
import { UInt32, UInt64 } from './int.js';
import { MethodInterface, Proof } from './proof-system.js';
...
declare class SmartContract extends SmartContractBase {
    ...
    static Proof(): {
        new ({ proof, publicInput, publicOutput, maxProofsVerified, }: {
            ...
            toJSON(): import("./proof-system.js").JsonProof;
        };
        ...
        publicOutputType: import("./circuit-value.js").ProvablePureExtended<undefined, null>;
        ...
        }>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: import("./proof-system.js").JsonProof): Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>;
