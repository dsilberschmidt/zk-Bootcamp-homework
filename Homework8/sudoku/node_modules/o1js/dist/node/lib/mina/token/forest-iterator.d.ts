...
declare const Layer_base: (new (value: {
    forest: MerkleListIterator<{
        id: number;
        accountUpdate: import("../../provable-types/packed.js").Hashed<AccountUpdate>;
        children: import("../../provable-types/merkle-list.js").MerkleListBase<AccountUpdateTreeBase>;
    }>;
    mayUseToken: {
...
declare class TokenAccountUpdateIterator {
    ...
    next(): {
        ...
        usesThisToken: import("../../bool.js").Bool;
    };
