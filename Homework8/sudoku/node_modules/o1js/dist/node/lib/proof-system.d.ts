import { ProvablePure, Pickles, Gate, GateType } from '../snarky.js';
import { Field, Bool } from './core.js';
import { FlexibleProvable, FlexibleProvablePure, InferProvable, ProvablePureExtended } from './circuit-value.js';
import { Provable } from './provable.js';
import { FieldConst } from './field.js';
import { Cache } from './proof-system/cache.js';
export { Proof, SelfProof, JsonProof, ZkProgram, ExperimentalZkProgram, verify, Empty, Undefined, Void, VerificationKey, };
...
declare function verify(proof: Proof<any, any> | JsonProof, verificationKey: string | VerificationKey): Promise<boolean>;
type JsonProof = {
    publicInput: string[];
    publicOutput: string[];
    maxProofsVerified: 0 | 1 | 2;
...
declare namespace ZkProgram {
    var Proof: <PublicInputType extends FlexibleProvablePure<any>, PublicOutputType extends FlexibleProvablePure<any>>(program: {
        ...
        new ({ proof, publicInput, publicOutput, maxProofsVerified, }: {
            ...
            publicInput: import("../bindings/lib/provable-generic.js").InferProvable<PublicInputType, import("./field.js").Field>;
            publicOutput: import("../bindings/lib/provable-generic.js").InferProvable<PublicOutputType, import("./field.js").Field>;
            proof: unknown;
            maxProofsVerified: 0 | 2 | 1;
            shouldVerify: import("./bool.js").Bool;
            verify(): void;
        ...
        fromJSON<S extends Subclass<typeof import("./proof-system.js").Proof>>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: JsonProof): Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>;
        /**
         * Dummy proof. This can be useful for ZkPrograms that handle the base case in the same
         * method as the inductive case, using a pattern like this:
         *
...
declare function ExperimentalZkProgram<StatementType extends {
    ...
    verify: (proof: Proof<InferProvableOrUndefined<Get<StatementType, "publicInput">>, InferProvableOrVoid<Get<StatementType, "publicOutput">>>) => Promise<boolean>;
    digest: () => string;
    analyzeMethods: () => { [I in keyof Types]: {
        rows: number;
        digest: string;
        result: unknown;
        gates: Gate[];
    ...
    publicInputType: ProvableOrUndefined<Get<StatementType, "publicInput">>;
    publicOutputType: ProvableOrVoid<Get<StatementType, "publicOutput">>;
    privateInputTypes: { [I_1 in keyof Types]: Method<InferProvableOrUndefined<Get<StatementType, "publicInput">>, InferProvableOrVoid<Get<StatementType, "publicOutput">>, Types[I_1]>["privateInputs"]; };
    rawMethods: { [I_2 in keyof Types]: Method<InferProvableOrUndefined<Get<StatementType, "publicInput">>, InferProvableOrVoid<Get<StatementType, "publicOutput">>, Types[I_2]>["method"]; };
} & { [I_3 in keyof Types]: Prover<InferProvableOrUndefined<Get<StatementType, "publicInput">>, InferProvableOrVoid<Get<StatementType, "publicOutput">>, Types[I_3]>; };
declare namespace ExperimentalZkProgram {
    var Proof: <PublicInputType extends FlexibleProvablePure<any>, PublicOutputType extends FlexibleProvablePure<any>>(program: {
        name: string;
        publicInputType: PublicInputType;
        publicOutputType: PublicOutputType;
